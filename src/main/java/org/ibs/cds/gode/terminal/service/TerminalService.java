package org.ibs.cds.gode.terminal.service;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.pty4j.PtyProcess;
import com.pty4j.WinSize;
import com.sun.jna.Platform;
import org.ibs.cds.gode.terminal.util.LibraryLoader;
import org.ibs.cds.gode.terminal.util.ThreadManager;
...
public class TerminalService {
    ...
    private void initializeProcess() throws Exception {
        ...
        File pathAbs = new File(getDirectory()).getAbsoluteFile();
        pathAbs.mkdirs();
        Path dataDir = pathAbs.toPath();
        LibraryLoader.load(dataDir);
        ...
        this.process = PtyProcess.exec(termCommand, envs, directory);
    ...
    private String getDirectory() {
        String dir = directory == null ? System.getProperty("user.home") : directory;
        return dir.concat(File.separator).concat(".terminalfx");
    }
